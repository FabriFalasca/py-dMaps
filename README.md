...
- Domains can overlap: when we plot the domains and stength maps in the tutorial it is not possible to see the overlapping. A way to show it is to plot also the domains borders (we will do it soon).
